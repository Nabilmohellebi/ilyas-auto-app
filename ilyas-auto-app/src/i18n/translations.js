...
export const fr = {
  ...
  card: { reserver: 'RÉSERVER / ACHETER', vendu: 'VÉHICULE VENDU', neuf: 'Neuf / 0 km', nouveau: '🆕 Nouveau' },
  ...
  reservation: {
    titre: 'Réserver ce véhicule', sousTitre: 'Un conseiller vous recontacte rapidement.',
    ...
    envoye: 'Demande envoyée !', merci: 'Notre équipe vous contactera très vite.',
  ...
  detail: {
    ...
    reserver: '🚘 Réserver ce véhicule', vendu: '🚫 Véhicule vendu', prix: 'Prix', video: '🎬 Voir la vidéo',
  },
  finance: {
...
export const ar = {
  ...
  card: { reserver: 'احجز / اشترِ', vendu: 'تم البيع', neuf: 'جديدة / 0 كم', nouveau: '🆕 جديد' },
  ...
  reservation: {
    titre: 'احجز هذه السيارة', sousTitre: 'سيتواصل معك أحد المستشارين قريبًا.',
    ...
    envoye: 'تم إرسال الطلب!', merci: 'سيتواصل معك فريقنا قريبًا.',
  ...
  detail: {
    ...
    reserver: '🚘 احجز هذه السيارة', vendu: '🚫 السيارة مباعة', prix: 'السعر', video: '🎬 مشاهدة الفيديو',
  },
  finance: {
    titre: '💰 محاكي التمويل',
